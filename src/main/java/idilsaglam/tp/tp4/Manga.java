...
public class Manga extends Media {
   ...
   * @param sortieInitial Une chaîne de caractères du format dd/MM/yyyy pour la date de sortie
   *     initiale
   * @throws ParseException Quand la chaîne de caractère n'est pas sous forme de dd/MM/yyyy
   */
  public Manga(String nom, String dessinateur, String editeur, int nbVolumes, String sortieInitial)
  ...
  public String toString() {
    return String.format(
        "Manga dessinateur %s, editeur %s, nombre de volumes %d, date de sortie initiale %s. %s",
        this.dessinateur,
        this.editeur,
        this.nbVolumes,
