...
public abstract class Media implements Comparable<Media> {
  ...
  // La fonction ordreMedia doit être une méthode d'instance abstraite pour que tous les
  // sous-classes doivent obligatoirement le définir.
  /**
   * La méthode associe un nombre entier en fonction du type de media.
   *
   * @return Un entier associé au type de media.
   */
  public abstract int ordreMedia();
  ...
  /**
   * Exercice 1.4 Une fonction qui vérifie que le numéro d'enregistrement de l'instance courante est
   * plus petit que celui de doc
   *
   * @param doc
