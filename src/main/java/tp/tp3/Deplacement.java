...
public class Deplacement {
  ...
  /**
   * Fonction qui vérifie si le déplacement est possible pour les déplacements horizontal, vertical est diagonale.
   * Une déplacement est dite possible, si tous les pièces en cours de route sont vide.
