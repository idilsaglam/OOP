...
public class Mediatheque {
    ...
    public void ajouter(Media doc){
        ...
        // Si on arrive là, c'est parce que soit la liste est vide, soit on doit ajouter à la fin de la liste
    ...
    public ArrayList<Media> recherche(Predicat p){
        return this.baseDeDonnees.stream().filter(p::estVrai).collect(Collectors.toCollection(ArrayList::new));
     /*
